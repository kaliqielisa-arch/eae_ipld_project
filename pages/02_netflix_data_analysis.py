...
num_missing_directors = int(movies_df["director"].isna().sum())

# TODO: Ex 2.4: How many different countries are there in the data?
countries_series = movies_df["country"].dropna().str.split(", ").explode()
n_countries = int(countries_series.nunique())

# TODO: Ex 2.5: How many characters long are on average the title names?
avg_title_length = float(movies_df["title"].str.len().mean())
...
movies_only = movies_only[movies_only["duration"].notna()]

movies_only["movie_minutes"] = (
    movies_only["duration"]
...
movies_avg_duration_per_year = (
    movies_only
    .groupby("release_year")["movie_minutes"]
    .mean()
)
